        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="/proyecto/view/cliente/index.php">Lista de Clientes</a></li>
                    <li><a class="dropdown-item" href="/proyecto/view/cliente/create.php">Agregar Clientes</a></li>
                </ul>
                </li>
            </ul>
            </div>
